...
-- CreateIndex
CREATE UNIQUE INDEX "PromotionChannel_name_key" ON "PromotionChannel"("name");

-- CreateIndex
CREATE UNIQUE INDEX "PromotionRule_name_key" ON "PromotionRule"("name");

-- CreateIndex
CREATE UNIQUE INDEX "PromotionCategory_name_key" ON "PromotionCategory"("name");
