...
CREATE TABLE "PromotionRuleset" (
    ...
    CONSTRAINT "PromotionRuleset_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "Event" (
    ...
    "archivedAt" TIMESTAMP(3),
    "promotionRulesetId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "PromotionRuleset_name_key" ON "PromotionRuleset"("name") WHERE ("archivedAt" IS NULL);
...
-- AddForeignKey
ALTER TABLE "PromotionRule" ADD CONSTRAINT "PromotionRule_promotionRulesetId_fkey" FOREIGN KEY ("promotionRulesetId") REFERENCES "PromotionRuleset"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Event" ADD CONSTRAINT "Event_promotionRulesetId_fkey" FOREIGN KEY ("promotionRulesetId") REFERENCES "PromotionRuleset"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
